...
{
    public partial class MainPage_Old : ContentPage, INotifyPropertyChanged
    {
        ...
        public MainPage_Old(IVolumeButtonService volumeButtonService, bool? showDrawerOnStart = null)
        {
            InitializeComponent();
